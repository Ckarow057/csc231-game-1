...
Gas::Gas(Vec position, int damage) : position{position}, damage{damage} {}

void Gas::execute(Engine& engine) {
    if (frame_count == 0) {
        sprite = engine.graphics.get_animated_sprite("gas", 2);
...
void Gas::when_done(Engine& engine) {
